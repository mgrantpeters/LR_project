...
ggsave(
  filename="plots/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation1_thr07.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 7,
...
ggsave(
  filename="plots/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation2_thr07.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 20,
...
ggsave(
  filename="plots/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation1_thr04.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 7,
...
write.csv(data.frame(full_results$results), "processed_data/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation1_thr04.csv", row.names=TRUE, quote=FALSE) 
...
ggsave(
  filename="plots/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation2_thr04.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 20,
...
write.csv(data.frame(full_results$results), "processed_data/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation2_thr04.csv", row.names=TRUE, quote=FALSE) 
rm(full_results)
rm(plot_list)
...
ggsave(
  filename="plots/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation1_thr055.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 7,
...
write.csv(data.frame(full_results$results), "processed_data/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation1_thr055.csv", row.names=TRUE, quote=FALSE) 
...
ggsave(
  filename="plots/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation2_thr055.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 20,
...
write.csv((.packages()), "processed_data/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/loaded_R_packages.R")


write.csv(FinalResult1, "processed_data/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/final_results_table_annot1.csv")
sig1 = FinalResult1[FinalResult1$q>0.05,]

FinalResult1 = read.csv("processed_data/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/final_results_table_annot1.csv", row.names = 1)


FinalResult1 %>% 
  mutate(CellType = factor(CellType,c("Astro","Micro","OPC","Oligo","EndoMural",    
                                      "Inhib","Excit_L6",  
                                      "Excit_L5_6","Excit_L5",    
                                      "Excit_L4","Excit_L3_4_5","Excit_L3","Excit_L2_3"))) %>%        
  ggplot() +
  ...
  theme(axis.line = element_line(colour = "black"), 
        ...
        legend.box="vertical") 
ggsave(
  filename="plots/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation1_multiple_thr.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 8,
...
write.csv(FinalResult, "processed_data/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation1_multiple_thr.csv")
...
ggsave(
  filename="plots/03-LR_network_visualisation/03c-specificity_major_network_DLPFC/annotation2_multiple_thr.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 8,
