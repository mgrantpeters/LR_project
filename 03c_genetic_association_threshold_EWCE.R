...
thisResult1$testList = '07_threshold'
...
thisResult$testList = '07_threshold'
...
thisResult1 = data.frame(full_results$results)
thisResult1$MajorCellType = unlist(lapply(strsplit(as.character(thisResult1$CellType),'_'), `[[`, 1))
thisResult1$testList = '04_threshold'
...
thisResult = data.frame(full_results$results)
thisResult$MajorCellType = unlist(lapply(strsplit(as.character(thisResult$CellType),'_'), `[[`, 1))
thisResult$testList = '04_threshold'
...
thisResult1 = data.frame(full_results$results)
thisResult1$MajorCellType = unlist(lapply(strsplit(as.character(thisResult1$CellType),'_'), `[[`, 1))
thisResult1$testList = '01_threshold'
FinalResult1 = rbind(FinalResult1,thisResult1)
...
ggsave(
  filename="plots/03-LR_network_visualisation/03c-specificity_major_network/annotation1_thr01.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 7,
...
write.csv(data.frame(full_results$results), "processed_data/03-LR_network_visualisation/03c-specificity_major_network/annotation1_thr01.csv", row.names=TRUE, quote=FALSE) 
...
thisResult = data.frame(full_results$results)
thisResult$MajorCellType = unlist(lapply(strsplit(as.character(thisResult$CellType),'_'), `[[`, 1))
thisResult$testList = '01_threshold'
FinalResult = rbind(FinalResult,thisResult)
...
ggsave(
  filename="plots/03-LR_network_visualisation/03c-specificity_major_network/annotation2_thr01.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 20,
