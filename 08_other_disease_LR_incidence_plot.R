...
data = read.csv("processed_data/01-clustering_genes_and_diseases/01a_LR_occurrance_across_diseases/LR_occurance_controls_0.1.csv")
data$padj = p.adjust(data$pval, method="fdr")


data %>% 
  mutate(Disease = factor(Disease,rev(c("CardiovascularDisease", "CoronaryHeartDisease", "Asthma", "RheumatoidArthritis", "DiabetesMellitus", "LymphoidLeukemia")))) %>%
  ggplot() +
  ...
  theme(axis.line = element_line(colour = "black"), 
        ...
        legend.box="vertical") 
ggsave(
  filename="plots/LR_occurance_per_disease_control_01.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 7,
...
data = read.csv("processed_data/01-clustering_genes_and_diseases/01a_LR_occurrance_across_diseases/LR_occurance_controls_0.4.csv")
data$padj = p.adjust(data$pval, method="fdr")
data %>% 
  mutate(Disease = factor(Disease,rev(c("CardiovascularDisease", "CoronaryHeartDisease", "Asthma", "RheumatoidArthritis", "DiabetesMellitus", "LymphoidLeukemia")))) %>%
  ggplot() +
  ...
  theme(axis.line = element_line(colour = "black"), 
        ...
        legend.box="vertical") 
ggsave(
  filename="plots/LR_occurance_per_disease_controls_04.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 6,
...
data = read.csv("processed_data/01-clustering_genes_and_diseases/01a_LR_occurrance_across_diseases/LR_occurance_controls_0.7.csv")
data$padj = p.adjust(data$pval, method="fdr")
data %>% 
  mutate(Disease = factor(Disease,rev(c("CardiovascularDisease", "CoronaryHeartDisease", "Asthma", "RheumatoidArthritis", "DiabetesMellitus", "LymphoidLeukemia")))) %>%
  ggplot() +
  ...
  theme(axis.line = element_line(colour = "black"), 
        ...
        legend.box="vertical") 
ggsave(
  filename="plots/LR_occurance_per_disease_controls_07.png",
  plot = last_plot(),
  device ="png",
  scale = 1,
  width = 7,
